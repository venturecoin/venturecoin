TEMPLATE = app
TARGET = venturecoin-qt
macx:TARGET = "Venturecoin-Qt"
VERSION = 0.1.3.1
...
EVENT_INCLUDE_PATH=C:/deps/libevent-2.0.21-stable/include
EVENT_LIB_PATH=C:/deps/libevent-2.0.21-stable/.libs
...
macx:ICON = src/qt/res/icons/venturecoin.icns
